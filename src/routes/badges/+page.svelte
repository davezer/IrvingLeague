<script>
  ...
  const sections = data?.sections || { personas: [], weekly: [], stains: [], yearly: [], legacy: [], luck: [] };
...
<!-- Section: Luck Badges -->
<section class="badge-section" id="luck">
  <h2 class="section-title">Luck Badges</h2>
  <div class="grid">
    {#each filterBadges(sections.luck) as badge}
      <!-- svelte-ignore a11y_no_noninteractive_tabindex -->
      <!-- svelte-ignore a11y_no_noninteractive_element_interactions -->
      <article
        class="card clickable"
