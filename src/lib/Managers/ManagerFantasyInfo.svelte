<script context="module">
  ...
  export async function load() {
    ...
    try {
      ...
      console.error('Error fetching pivot data:', e);
    }

    return { draftMoneyCurrentYear, draftMoneyNextYear };
  }
</script>

<script>
  export let data; // { draftMoneyCurrentYear, draftMoneyNextYear }
  export let viewManager;
  export let players;
  export let changeManager;

  const { draftMoneyCurrentYear, draftMoneyNextYear } = data;
  if (draftMoneyCurrentYear !== null) viewManager.draftMoneyCurrentYear = draftMoneyCurrentYear;
  if (draftMoneyNextYear !== null) viewManager.draftMoneyNextYear = draftMoneyNextYear;
</script>
